...
\fancyhead[RO,LE]{\textit {\textsl{Tytuł pracy} \ldots}} % tekst w nagłówku
...
\Large {WYDZIAŁ ELEKTRYCZNY}\\[1mm]
\begin{large}
Instytut Elektroenergetyki\\[1mm]
Zakład Wysokich Napięć i Materiałów Elektrotechnicznych\\[1cm]
\end{large}
\end{center}

\begin{center}
\includegraphics[height=3cm,keepaspectratio]{logo.pdf}
\end{center}

\vspace{1cm}

\begin{center}
\Large \textbf {Imię Nazwisko}
\end{center}

\vspace{1cm}

\begin{center}
\Large \textbf{\textit{TYTUŁ PRACY DYPLOMOWEJ}}
\end{center}

\vspace{3cm}
\hfill
\textbf {Promotor}: dr inż. Imię Nazwisko
...
% WSTĘP _____________________________________________________________________________________________________________________
