...
Podstawiając wartości liczbowe stałych ($k_{\mathrm{mech}} = 0{,}2$, $c_{\mathrm{ball}} \approx 5{,}886$, $T_{\mathrm{serwo}} = 0{,}095$):

\begin{equation}
\begin{bmatrix} \dot{x}_1 \\ \dot{x}_2 \\ \dot{x}_3 \end{bmatrix} = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1,177 \\ 0 & 0 & -10,526 \end{bmatrix} \begin{bmatrix} x_1 \\ x_2 \\ x_3 \end{bmatrix} + \begin{bmatrix} 0 \\ 0 \\ 10,526 \end{bmatrix} u
\end{equation}
